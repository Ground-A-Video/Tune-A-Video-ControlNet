# https://github.com/huggingface/diffusers/blob/e828232780554d54bdb527d3390fab0be042b72a/src/diffusers/models/controlnet.py
...
class ControlNetConditioningEmbedding(nn.Module):
    ...
    def forward(self, conditioning):
        '''
        Note: In Tune-A-Video + ControlNet, we do not inflate conv2d to conv3d for ControlNet Hint Encoders. Empirically, this produce better results.
        '''
        # b f -> (b f) : to compute conv2d
        ...
        # (b f) -> b f : back to video dim
        embedding = rearrange(embedding, "(b f ) c h w -> b c f h w", b=b)
